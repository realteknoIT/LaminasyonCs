...
{
    /// <summary>
    /// spinnerSag.xaml etkileşim mantığı
    /// </summary>
    public partial class spinnerSag : UserControl, INotifyPropertyChanged
    {
        ...
        public double Scales
        {
            ...
            set
            {
                if (Math.Abs(scalesProperty - value) > 0.001)
                {
                    ...
                    scaleTransform.ScaleX = scalesProperty;
